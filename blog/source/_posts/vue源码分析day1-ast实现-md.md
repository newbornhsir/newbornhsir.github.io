---
title: vue源码分析day1-ast实现.md
date: 2018-03-09 16:30:37
tags: vue
categories: vue
---
...
parseHTML主要对html进行截取，匹配，分析，然后调用传入的options中的处理函数，在父级函数中形成ast机构。
...
github地址:[html转换ast的简单实现](https://github.com/newbornhsir/vue/tree/master/day1)，如果喜欢的话，请给个start。